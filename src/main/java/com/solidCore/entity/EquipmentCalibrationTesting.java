...
/**
 * 设备校准测试实体类
 * 对应数据库表：equipment_calibration_testing
 */
@TableName(value ="equipment_calibration_testing")
@Data
public class EquipmentCalibrationTesting implements Serializable {
    /**
     * 编号
     */
    ...
    private BigDecimal mainSecondarySuctionResistance;
    ...
    private BigDecimal residualPressureTableRatio;
